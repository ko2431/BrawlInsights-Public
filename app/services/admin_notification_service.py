...
EVENT_CATALOG: tuple[AdminNotificationEvent, ...] = (
    ...
    AdminNotificationEvent("penalty_applied", "penalties", "ペナルティの適用", 20, "/admin/penalties"),
    ...
    AdminNotificationEvent("token_gift_created", "token_gifts", "トークン進呈", 20, "/admin/token-gifts"),
    ...
    AdminNotificationEvent("map_rotation_slot_created", "map_rotation", "マップ周期の新スロット", 20, "/admin/map-rotation"),
    AdminNotificationEvent("map_rotation_changed", "map_rotation", "マップ周期の変更", 20, "/admin/map-rotation"),
    AdminNotificationEvent("map_rotation_cycle_length_changed", "map_rotation", "マップ周期の日数変更", 30, "/admin/map-rotation"),
    AdminNotificationEvent("map_rotation_switch_time_changed", "map_rotation", "マップ周期の切り替え時刻変更", 20, "/admin/map-rotation"),
    AdminNotificationEvent("map_rotation_slot_missing", "map_rotation", "マップ周期スロットの未観測", 20, "/admin/map-rotation"),
    AdminNotificationEvent("map_rotation_confirmed", "map_rotation", "マップ周期の確定", 10, "/admin/map-rotation"),
    AdminNotificationEvent("ranked_map_pool_changed", "ranked_maps", "ガチバトルマップの変更検出", 20, "/admin/ranked-maps"),
    AdminNotificationEvent("ranked_max_power_missing", "ranked_maps", "最大レベルキャラの未設定", 20, "/admin/ranked-maps"),
...
CATEGORY_LABELS: dict[str, str] = {
    ...
    "modes": "ゲームモード情報管理",
    "maps": "マップ情報管理",
    "map_rotation": "マップ周期管理",
    "ranked_maps": "ガチバトルマップ管理",
    "titles": "キャッチフレーズ情報管理",
    "frames": "バトルカード背景情報管理",
