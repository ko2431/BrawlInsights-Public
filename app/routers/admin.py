...
from app.core.admin_permissions import (
    HOME_ADMIN_PAGES,
    HOME_EXTERNAL_LINKS,
    PERM_ACCESSORIES_EDIT,
    PERM_ANNOUNCEMENTS_EDIT,
    PERM_BRAWLERS_EDIT,
    PERM_BRAWL_VIDEOS_EDIT,
    PERM_FAQS_EDIT,
    PERM_FEEDBACKS_EDIT,
    PERM_FRAMES_EDIT,
    PERM_GIFTCODES_EDIT,
    PERM_MAPS_EDIT,
    PERM_MAP_ROTATION_EDIT,
    PERM_RANKED_MAPS_EDIT,
    PERM_MESSAGES_EDIT_DELETED,
    PERM_MESSAGES_VIEW_IP,
    PERM_MINIGAME_CAMPAIGNS_EDIT,
